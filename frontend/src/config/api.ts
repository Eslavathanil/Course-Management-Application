...
export const API_BASE_URL =
  import.meta.env.VITE_API_URL || 'https://course-management-application.onrender.com/api';
...
export const API_ENDPOINTS = {
  ...
  enrollmentProgress: (courseId: string) =>
    `${API_BASE_URL}/enrollments/${courseId}/progress`,
} as const;
